 ...
 * |------------------------------------------------------------------|
 * |F-LL |GUI |Alt |     Space               |Alt |Fn  | |Lt |Dn|Rt   |
 * `------------------------------------------------------------------|'
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_65_ansi_blocker_splitbs(
        ...
        MO(_LL), KC_LGUI, KC_LALT,                  KC_SPC,                      KC_RALT, MO(_FL), KC_LEFT, KC_DOWN, KC_RGHT),

    [_FL] = LAYOUT_65_ansi_blocker_splitbs(
    ...
    [_LL] = LAYOUT_65_ansi_blocker_splitbs(
        ...
        _______, _______, _______,                   _______,                                     _______, _______, RGB_RMOD, RGB_HUD, RGB_MOD),
};